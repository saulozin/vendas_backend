...
public class ClienteFormRequest {
	...
	public ClienteFormRequest(LocalDate nascimento, String cpf, String nome, String endereco, String telefone,
			String email, LocalDate dtCadastro) {
		super();
		this.nascimento = nascimento;
		this.cpf = cpf;
	...
	public Cliente toModel() {
		return new Cliente(id, nascimento, cpf, nome, endereco, telefone, email, dtCadastro);
	}
	
	public static ClienteFormRequest fromModel(Cliente cliente) {
		return new ClienteFormRequest(
				cliente.getId(), cliente.getNascimento(), cliente.getCpf(), cliente.getNome(),
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ClienteFormRequest other = (ClienteFormRequest) obj;
		return Objects.equals(id, other.id);
	}

	@Override
	public String toString() {
		return "ClienteFormRequest [id=" + id + ", nascimento=" + nascimento + ", cpf=" + cpf + ", nome=" + nome
				+ ", endereço=" + endereco + ", telefone=" + telefone + ", email=" + email + ", dtCadastro="
				+ dtCadastro + "]";
	}
